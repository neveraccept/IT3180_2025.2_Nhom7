...
/**
 * Kết quả nhập hóa đơn điện/nước/internet hàng loạt từ file Excel.
 *  - createdCount: số hóa đơn tạo thành công.
 *  - failedCount: số dòng bị lỗi (trùng hóa đơn, thiếu chỉ số, loại sai...).
